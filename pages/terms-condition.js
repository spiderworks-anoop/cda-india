...
import { TermsAndConditionsApi } from "@/Datas/endpoints/termsandcondition";
...
export async function getStaticProps() {
  try {
    ...
    const TermsData = await TermsAndConditionsApi.termsConditions();
